...
Automatic and manual packaging intentionally converge after packaging: both mount the same shared carrier-rate and PayDemo renderer. Their requests and packaging inputs remain independent, while carrier selection, payment hierarchy, accessibility semantics, and SDK-compatible completion events stay structurally identical.
